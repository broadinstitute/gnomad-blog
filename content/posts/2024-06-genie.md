...
We plan to continue to add new features to GeniE, including but not limited to: supporting multiple inheritance patterns, displaying the count of variants contributing to the carrier frequency of each genetic ancestry group, creating a “removed variants” table to estimates, and allowing for multiple estimates to be added together. If you have any feature requests please email [prev-genie@broadinstitute.org](mailto:prev-genie@broadinstitute.org) or [file an issue via GitHub](https://github.com/broadinstitute/genetic-prevalence-estimator/issues).
