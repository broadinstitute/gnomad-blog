...
On the variant co-occurrence [page](https://gnomad.broadinstitute.org/variant-cooccurrence), users can input the information for any pair of variants within a single gene using a chr-pos-ref-alt format based on hg19/GRCh37 coordinates. The browser may return one of three possibilities:
