...
* Downloadable data file containing all results displayed in the browser, as well as additional results  generated using off-target regions [**TODO link**]
...
We also ran [REViewer](https://github.com/Illumina/REViewer) to generate read visualizations for all samples at all 59 loci. Finally, we used python scripts in the [STR-analysis repo](https://github.com/broadinstitute/str-analysis) to aggregate results into the JSON format available for download.
