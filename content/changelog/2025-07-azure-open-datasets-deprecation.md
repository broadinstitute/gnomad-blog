...
Starting **August 15, 2025**, gnomAD data will no longer be accessible via Azure Open Datasets due to [Microsoft Azure's planned deprecation of genomic datasets](https://learn.microsoft.com/en-us/azure/open-datasets/dataset-gnomad).
