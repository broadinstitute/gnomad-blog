...
Note that in the updated track, regions that have low coverage (percent allele number or median %AN < 90) or observed to expected ratios not significantly different from 1 are colored in gray.
